...
func RendeOverview() {
	...
	//    - 2d floor     -> page with [bathroom, stair way, master bedroom, bedroom]
	//    - 1st floor    -> page with [bathroom, stair way, living room, study room, washing room]
	//    - ground floor -> page with [entrance, bathroom, stair way, kitchen, dining room, living room, bedroom]
	//    - basement     -> page with [front room, stair way, back room]
